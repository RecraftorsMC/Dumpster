...
public abstract class StraightMixin extends TrunkPlacer implements IObjectable {
    StraightMixin(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
