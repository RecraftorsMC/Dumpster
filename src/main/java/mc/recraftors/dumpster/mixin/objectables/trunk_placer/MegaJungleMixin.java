...
public abstract class MegaJungleMixin extends TrunkPlacer implements IObjectable {
    MegaJungleMixin(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
