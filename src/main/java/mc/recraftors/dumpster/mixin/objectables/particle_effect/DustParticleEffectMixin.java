...
public abstract class DustParticleEffectMixin extends AbstractDustParticleEffect implements IObjectable {

    @Shadow public abstract ParticleType<DustParticleEffect> getType();

    DustParticleEffectMixin(Vec3f color, float scale) {
        super(color, scale);
    }
