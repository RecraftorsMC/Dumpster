...
@Mixin(TwoLayersFeatureSize.class)
public abstract class TwoLayersMixin extends FeatureSize implements IObjectable {
    ...
    TwoLayersMixin(OptionalInt minClippedHeight) {
    ...
    public JsonObject dumpster$toJson() {
        ...
        o.add("uppser_size", new JsonPrimitive(upperSize));
        return o;
    }
}
