...
public abstract class SpruceMixin extends FoliagePlacer implements IObjectable {
    @Shadow @Final private IntProvider trunkHeight;

    SpruceMixin(IntProvider radius, IntProvider offset) {
        super(radius, offset);
    }
    ...
    public JsonObject dumpster$toJson() {
        ...
        o.add("trunk_height", JsonUtils.objectJson(trunkHeight));
        return o;
    }
}
